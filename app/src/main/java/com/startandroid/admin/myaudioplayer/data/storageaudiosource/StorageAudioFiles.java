...
public class StorageAudioFiles {
    ...
    public void setOnDataChangedCallback(MusicDataSource.OnDataChangedCallback callback){
        mOnDataChangedCallback = callback;
    }

    public List<Audio> getStorageAudios(String selection, String[] selectionArgs){
    ...
    public Audio getAudioById(String audioId) {
    ...
    public Maybe<Audio> getAudioByIdAsync(String id){
    ...
    /*public Flowable<List<Audio>> getAudiosAsync (String selection, String[] selectionArgs) {
        Flowable<List<Audio>> flowable= Flowable.fromCallable(
   ...
   /* public void deleteAudioById(String id) {
    ...
    @NonNull
    private MediaMetadataCompat makeMetadataFromAudioModel(@NonNull Audio audio) {
    ...
    @NonNull
    private List<MediaMetadataCompat> makeMetadataFromAudioModel(@NonNull List<Audio> audios) {
