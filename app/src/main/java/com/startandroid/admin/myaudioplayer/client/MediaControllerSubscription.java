...
public class MediaControllerSubscription {
    ...
    private BehaviorSubject<Integer> mShuffleMode = BehaviorSubject.create();
    private BehaviorSubject<Integer> mRepeatMode = BehaviorSubject.create();
    ...
    public BehaviorSubject<Integer> getShuffleMode() {
        return mShuffleMode;
    }

    public void setShuffleMode(int shuffleMode) {
        mShuffleMode.onNext(shuffleMode);
    }

    public BehaviorSubject<Integer> getRepeatMode() {
        return mRepeatMode;
    }

    public void setRepeatMode(int repeatMode) {
        mRepeatMode.onNext(repeatMode);
    }
